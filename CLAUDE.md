...
| index.html | 2282 | 148 KB |
| dg-system.css | 5279 | 490 KB |
| tests/uat.js + tests/uat/ (27 modules) | 28431 | — |
UAT checks: 4928 · E2E `test(` count: 160 · APP_VERSION: 8.5.0 · stamped-at: worktree
<!-- FACTS:AUTO:END -->
...
**Reality check:** `app.js` size is the driver for [#138](https://github.com/oremosu98/certanvil/issues/138) (module split) — unfrozen 2026-07-17 — incremental extraction in progress, see plan. `styles.css` growth drove [#55](https://github.com/oremosu98/certanvil/issues/55) — same gate.
