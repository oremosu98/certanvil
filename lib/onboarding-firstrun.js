  ...
  function onClick(e) {
    ...
    if (action === 'pick-cert') {
      ...
      if (state.tier !== 'pro') {
        ...
        if (!window.confirm(nm + ' will be your free exam. On the free plan you study one exam at a time. Pro unlocks all of them and lets you switch. Continue with ' + nm + '?')) return;
