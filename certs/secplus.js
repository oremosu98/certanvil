...
window.CERT_PACKS.secplus = {
  ...
  questionExemplars: [
    ...
    {"type":"mcq","question":"An attacker calls the company helpdesk impersonating the CFO and demands an immediate password reset, citing an upcoming board meeting. The helpdesk technician complies without verifying the caller's identity. Which social engineering technique BEST describes this attack?","difficulty":"Exam Level","topic":"Social Engineering","objective":"2.2","options":{"A":"Phishing","B":"Vishing","C":"Smishing","D":"Whaling"},"answer":"B","explanation":"Vishing is voice-based social engineering performed over the phone. The attacker used voice + impersonation + urgency pressure — classic vishing. Phishing (A) is email-based. Smishing (C) is SMS-based. Whaling (D) targets high-value executives but is typically email-delivered and identifies the target rather than the impersonator; here the impersonator claims to be the executive, making vishing the more precise label.","source":"curated-secplus-phase3","addedVersion":"7.4.0","addedDate":"2026-05-27"},
    {"type":"mcq","question":"An accounts payable clerk receives an email appearing to be from the CEO requesting an urgent wire transfer of $90,000 to a new vendor. The email signature, formatting, and writing style match the CEO's prior correspondence. The clerk processes the transfer; the funds are unrecoverable. Which attack type is this?","difficulty":"Exam Level","topic":"Social Engineering","objective":"2.2","options":{"A":"Spear phishing","B":"Whaling","C":"Business email compromise","D":"Pharming"},"answer":"C","explanation":"Business email compromise (BEC) specifically targets the financial-transaction approval chain, impersonating an executive to authorize wire transfers or invoice payments. Spear phishing (A) is the broader technique BEC builds on. Whaling (B) targets the executive themselves as victim; here the executive is the impersonated identity, not the target. Pharming (D) redirects users to malicious sites via DNS manipulation, unrelated to email content. CompTIA distinguishes BEC as a specific category in objective 2.2.","source":"curated-secplus-phase3","addedVersion":"7.4.0","addedDate":"2026-05-27"},
    {"type":"mcq","question":"A finance employee receives an SMS message reading: 'IRS notice: outstanding tax balance. Pay within 24 hours to avoid prosecution. Click https://irs-payment-secure.co/file'. The link leads to a credential-harvesting page. Which attack technique is this?","difficulty":"Foundational","topic":"Social Engineering","objective":"2.2","options":{"A":"Phishing","B":"Vishing","C":"Smishing","D":"Watering hole"},"answer":"C","explanation":"Smishing is SMS-based phishing — the 'sms' + 'phishing' portmanteau. Phishing (A) is the general category but CompTIA expects the specific delivery-channel label when the question specifies SMS. Vishing (B) is voice-call-based. Watering hole (D) compromises a website the target population is known to visit, not direct messaging.","source":"curated-secplus-phase3","addedVersion":"7.4.0","addedDate":"2026-05-27"},
    {"type":"mcq","question":"A targeted attack against the CISO of a Fortune 500 company uses a highly customized email referencing the CISO's recent industry talk and including a malicious PDF attachment supposedly containing speaker feedback. Which classification BEST applies?","difficulty":"Exam Level","topic":"Social Engineering","objective":"2.2","options":{"A":"Phishing","B":"Spear phishing","C":"Whaling","D":"Business email compromise"},"answer":"C","explanation":"Whaling is spear phishing aimed specifically at high-value executives (C-suite, board members). The CISO is the explicit target, and the personalization (recent talk reference) confirms the targeted nature. Phishing (A) is broad and untargeted. Spear phishing (B) is targeted but not necessarily executive-level; whaling is the more specific term when the target is an executive. BEC (D) impersonates an executive to defraud others; here the executive is the victim, not the impersonator.","source":"curated-secplus-phase3","addedVersion":"7.4.0","addedDate":"2026-05-27"},
    {"type":"mcq","question":"An attacker contacts the IT helpdesk claiming to be a new contractor working on a security audit. They reference a real project name (gathered from LinkedIn) and request elevated access to verify firewall configurations. The story is fabricated but plausible. Which technique is the attacker using?","difficulty":"Exam Level","topic":"Social Engineering","objective":"2.2","options":{"A":"Pretexting","B":"Tailgating","C":"Brand impersonation","D":"Typosquatting"},"answer":"A","explanation":"Pretexting is the fabrication of a believable scenario (a 'pretext') to manipulate the target into compliance. The attacker built a story — contractor + real project name + plausible business need — to gain trust. Tailgating (B) is physical (following someone through a secure door). Brand impersonation (C) imitates a known brand's communications, not a fake employee identity. Typosquatting (D) registers misspelled domain names to catch typos, unrelated to this scenario.","source":"curated-secplus-phase3","addedVersion":"7.4.0","addedDate":"2026-05-27"},
    {"type":"mcq","question":"Threat actors compromise a developer forum frequented by employees of a specific defense contractor. They embed exploit code in the forum's JavaScript that targets only browsers connecting from that contractor's IP ranges. Which attack pattern is this?","difficulty":"Hard","topic":"Social Engineering","objective":"2.2","options":{"A":"Spear phishing","B":"Watering hole","C":"Supply chain attack","D":"Brand impersonation"},"answer":"B","explanation":"Watering hole attacks compromise a third-party site that the target population is known to visit, waiting for them to come to the attacker. The IP-range filtering confirms targeting. Spear phishing (A) sends customized messages directly to targets. Supply chain attack (C) compromises a trusted vendor or component delivered to the target; here no vendor relationship is involved. Brand impersonation (D) mimics a known brand's communications.","source":"curated-secplus-phase3","addedVersion":"7.4.0","addedDate":"2026-05-27"},
    {"type":"multi-select","question":"Which TWO indicators in an email are MOST consistent with a phishing attempt?","difficulty":"Foundational","topic":"Social Engineering","objective":"2.2","options":{"A":"Sender domain 'paypa1-security.com'","B":"Reply-to address differs from sender domain","C":"Email contains the recipient's correct first name","D":"Message body is signed with a valid DKIM signature"},"answer":["A","B"],"explanation":"Typosquatted domains (A — using digit '1' for letter 'l') and mismatched Reply-to vs From addresses (B) are two of CompTIA's standard phishing indicators. The recipient's correct name (C) is increasingly common in spear phishing and is not a discriminator by itself. A valid DKIM signature (D) actually suggests the message is legitimately from the claimed sender's mail infrastructure — phishing attempts are MORE likely to fail DKIM.","source":"curated-secplus-phase3","addedVersion":"7.4.0","addedDate":"2026-05-27"},
    ...
    {"type":"mcq","question":"A sophisticated attack against a defense contractor's network uses previously unknown zero-day vulnerabilities, maintains stealth presence for over a year, and exfiltrates classified design documents. Investigation attributes the operation to a foreign government's intelligence service. Which threat actor classification fits BEST?","difficulty":"Foundational","topic":"Threat Actors & Motivations","objective":"2.1","options":{"A":"Nation-state","B":"Organized crime","C":"Hacktivist","D":"Insider threat"},"answer":"A","explanation":"Nation-state actors are characterized by extensive resources (zero-days are expensive to develop or buy), long-dwell sophisticated operations, and government-aligned objectives like espionage. The attribution to a foreign intelligence service confirms this. Organized crime (B) is typically financially motivated and less likely to spend zero-days on intellectual property. Hacktivists (C) seek publicity, not stealth. Insider threats (D) are by definition internal personnel.","source":"curated-secplus-phase3","addedVersion":"7.4.0","addedDate":"2026-05-27"},
    {"type":"mcq","question":"A group of attackers compromises a company's website and replaces the homepage with a manifesto criticizing the company's environmental record. They publish customer email addresses to a Pastebin to amplify the message. Which threat actor type and motivation fit BEST?","difficulty":"Foundational","topic":"Threat Actors & Motivations","objective":"2.1","options":{"A":"Hacktivist; philosophical/political beliefs","B":"Nation-state; espionage","C":"Organized crime; financial gain","D":"Insider threat; revenge"},"answer":"A","explanation":"Hacktivism is hacking motivated by political, social, or ideological beliefs, typically aimed at publicity and shame. Defacing the site with a manifesto + doxing customers to amplify the message is the canonical hacktivist signature. Nation-state (B) prioritizes stealth and intelligence value. Organized crime (C) monetizes access, not publishes manifestos. Insider threats (D) usually exploit internal access, not deface external websites with public messaging.","source":"curated-secplus-phase3","addedVersion":"7.4.0","addedDate":"2026-05-27"},
    {"type":"mcq","question":"A system administrator with 8 years of company tenure is passed over for a promotion. Over the next month, they exfiltrate customer data via personal cloud accounts and disable two critical backup jobs before resigning. Which threat actor type fits?","difficulty":"Foundational","topic":"Threat Actors & Motivations","objective":"2.1","options":{"A":"Insider threat","B":"Hacktivist","C":"Shadow IT","D":"Unskilled attacker"},"answer":"A","explanation":"Insider threats are legitimate users (employees, contractors) who misuse their authorized access for malicious ends. The 8-year tenure + access + motive (passed-over for promotion) is classic insider-threat shape. Hacktivists (B) are external and politically motivated. Shadow IT (C) is unauthorized but not necessarily malicious systems used by employees, a different category. Unskilled attacker (D) lacks deep technical capability; an 8-year sysadmin disabling backup jobs is skilled.","source":"curated-secplus-phase3","addedVersion":"7.4.0","addedDate":"2026-05-27"},
    {"type":"mcq","question":"A criminal group encrypts a hospital's electronic health records and demands $2 million in cryptocurrency for the decryption key, with a 72-hour deadline. They are well-funded, run a 'help desk' for victims, and have repeatedly targeted healthcare for the past 18 months. Which threat actor classification BEST applies?","difficulty":"Foundational","topic":"Threat Actors & Motivations","objective":"2.1","options":{"A":"Organized crime","B":"Hacktivist","C":"Unskilled attacker","D":"Nation-state"},"answer":"A","explanation":"Organized crime groups operate ransomware-as-a-service businesses with structured operations (the 'help desk' is a tell), financial motivation (ransom payment), and repeat targeting of sectors with willingness to pay. Hacktivists (B) seek publicity, not direct payment. Unskilled attackers (C) lack the infrastructure described. Nation-state (D) is government-aligned and typically targets intellectual property or political objectives, not ransom revenue.","source":"curated-secplus-phase3","addedVersion":"7.4.0","addedDate":"2026-05-27"},
