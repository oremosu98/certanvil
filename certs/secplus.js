...
window.CERT_PACKS.secplus = {
  ...
  questionExemplars: [
    ...
    {"type":"mcq","question":"An attacker compromises a company's IT software supplier and embeds a backdoor in the supplier's update mechanism. Months later, when the company installs a routine update, the backdoor activates inside the company's network. Which attack vector class is this?","difficulty":"Exam Level","topic":"Attack Vectors & Surfaces","objective":"2.2","options":{"A":"Supply chain attack (software provider)","B":"Watering hole","C":"Removable device","D":"Default credentials"},"answer":"A","explanation":"Supply chain attacks compromise a trusted vendor or component delivered to the target. The CompTIA SY0-701 objectives explicitly break supply chain into MSP, vendor, and supplier vectors; here the software provider is the compromised link (the SolarWinds-class archetype). Watering hole (B) compromises websites the targets visit. Removable device (C) is USB/media-based ingress. Default credentials (D) is an authentication weakness, not a vector class.","source":"curated-secplus-phase3","addedVersion":"7.4.0","addedDate":"2026-05-27"},
    {"type":"mcq","question":"During a security assessment, a USB drive labelled 'Q3 Bonus Calculations' is left in a company's parking lot. An employee picks it up and plugs it into their workstation. The drive auto-runs malware that beacons to an attacker-controlled server. Which attack vector is this?","difficulty":"Foundational","topic":"Attack Vectors & Surfaces","objective":"2.2","options":{"A":"Phishing","B":"Removable device","C":"Open service port","D":"Wireless"},"answer":"B","explanation":"Removable device vector covers USB drives, optical media, and any portable storage that introduces malicious code into a system on connection. The 'dropped USB in parking lot' is the canonical operational pattern. Phishing (A) is message-based; here no message was delivered. Open service port (C) is a network-attack-surface vector. Wireless (D) is RF-based.","source":"curated-secplus-phase3","addedVersion":"7.4.0","addedDate":"2026-05-27"},
    {"type":"mcq","question":"A vulnerability scan finds 47 production servers running an operating system version that the vendor stopped supporting 14 months ago. No security patches are available for any of them. Which attack-surface contribution does this represent?","difficulty":"Foundational","topic":"Attack Vectors & Surfaces","objective":"2.2","options":{"A":"Unsupported systems","B":"Default credentials","C":"Open service ports","D":"Removable device"},"answer":"A","explanation":"Unsupported systems and applications are systems whose vendor no longer provides security updates — any new vulnerabilities found will never be patched. CompTIA lists this explicitly as an attack vector category in 2.2 because the unpatchable surface is permanent. Default credentials (B) is a specific weakness category. Open service ports (C) and removable device (D) are different vector categories.","source":"curated-secplus-phase3","addedVersion":"7.4.0","addedDate":"2026-05-27"},
    {"type":"mcq","question":"A penetration tester gains access to an enterprise's network management system by logging in with vendor-published default credentials that were never changed during deployment. Which attack-surface category does this exploit?","difficulty":"Foundational","topic":"Attack Vectors & Surfaces","objective":"2.2","options":{"A":"Open service ports","B":"Default credentials","C":"Supply chain","D":"Bluetooth"},"answer":"B","explanation":"Default credentials — vendor-shipped username/password pairs that should be changed during deployment but weren't — are an enumerated attack-surface category in the SY0-701 objectives. Open service ports (A) is about exposed services, not authentication. Supply chain (C) is about trusted-vendor compromise. Bluetooth (D) is a specific wireless vector.","source":"curated-secplus-phase3","addedVersion":"7.4.0","addedDate":"2026-05-27"},
